...
import { downloadAllImageFromServerBySpMa } from "../redux/apiRequest";



function DrawerPreview({isDrawerPreviewOpen, closeDrawerPreview, productBySpMa}) {
    ...
    useEffect(() => {
        downloadAllImageFromServerBySpMa(productBySpMa.spMa,localStorage.getItem("token"), dispatch)
    },[]) 
